...
newtype EvaluationExpressionVar = EvaluationExpressionVarC Int deriving (Show)

type EvaluationTypeVar = ()

type EvaluationExpression = Expression EvaluationExpressionVar EvaluationTypeVar
